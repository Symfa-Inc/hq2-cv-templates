...
// src/index.ts
import_handlebars.default.registerHelper("isActiveItems", function(context, options) {
...
import_handlebars.default.registerHelper("ifMultiCondition", function(v1, v2, options) {
  if (v1 && v2) {
    return options.fn(this);
  }
  return options.inverse(this);
